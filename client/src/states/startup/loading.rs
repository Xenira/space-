...
const STATE: AppState = AppState::Loading;
...
pub struct GodAssets {
    ...
    pub god_frame: Handle<Image>,
    pub god_frame_layout: Handle<TextureAtlasLayout>,
...
pub struct CharacterAssets {
    ...
    pub upgraded: Handle<Image>,
    pub upgraded_layout: Handle<TextureAtlasLayout>,
    pub upgradable: Handle<Image>,
    pub upgradable_layout: Handle<TextureAtlasLayout>,
    pub duplicate: Handle<Image>,
    pub duplicate_layout: Handle<TextureAtlasLayout>,
}
...
fn load_gods_assets(
    ...
    god_assets.god_frame = asset_server.load("textures/ui/god_frame2.png");
    let god_frame_atlas = TextureAtlasLayout::from_grid(Vec2::new(64.0, 64.0), 18, 1, None, None);

    god_assets.god_frame_layout = texture_atlases.add(god_frame_atlas);
...
fn load_character_assets(
    ...
    character_assets.upgraded = asset_server.load("textures/ui/Effect_EldenRing_1_421x425.png");
    let upgrded_atlas = TextureAtlasLayout::from_grid(Vec2::new(421.0, 425.0), 6, 5, None, None);
    character_assets.upgraded_layout = texture_atlases.add(upgrded_atlas);

    character_assets.upgradable = asset_server.load("textures/ui/Effect_Wheel_1_273x273.png");
    let upgradable_atlas = TextureAtlasLayout::from_grid(Vec2::new(273.0, 273.0), 6, 5, None, None);
    character_assets.upgradable_layout = texture_atlases.add(upgradable_atlas);

    character_assets.duplicate =
        asset_server.load("textures/ui/Effect_ElectricShield_1_265x265.png");
    let duplicate_atlas = TextureAtlasLayout::from_grid(Vec2::new(265.0, 265.0), 6, 5, None, None);
    character_assets.duplicate_layout = texture_atlases.add(duplicate_atlas);
}
